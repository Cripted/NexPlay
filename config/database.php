...
if ($isLocal) {
    ...
    $password   = "";
    $dbname     = "nexplay";
    define('SITE_URL', 'http://localhost/NexPlay');
} else {
    // ── PRODUCCIÓN (atspace.cc) ──────────────────────────────────────────────
    $servername = "fdb1032.atspace.me";
    $username   = "4714565_nexplay";
    $password   = "Hectoroscar!23l3";
    $dbname     = "4714565_nexplay";
    define('SITE_URL', 'http://nex-play.atspace.cc');
}
