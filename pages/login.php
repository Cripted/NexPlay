...
<title>Iniciar Sesión · NexPlay</title>
<meta name="description" content="Inicia sesión en NexPlay para acceder a tu cuenta gamer.">
  ...
  <section style="display: flex; justify-content: center; align-items: center; min-height: 70vh;">
    <div class="container" style="max-width: 480px; width: 100%;">
      ...
      <div class="section-head" style="text-align: center; margin-bottom: 24px; max-width: 100%;">
        <p class="eyebrow">Acceso Gamer</p>
        <h2>Iniciar Sesión</h2>
        <p>Entra a tu cuenta para gestionar tus compras y participar en los foros.</p>
      </div>
      ...
      <div class="form-panel" style="background: var(--panel); border: 1px solid var(--line); border-radius: var(--radius); padding: 32px; box-shadow: 0 8px 32px rgba(0,0,0,0.4);">
        ...
        <form method="POST" action="login.php">
          ...
          <button type="submit" class="btn btn-primary btn-block" style="margin-top: 10px;">Iniciar Sesión</button>
        </form>

        <div style="margin-top: 24px; text-align: center; font-size: 0.9rem; color: var(--muted);">
          ¿No tienes una cuenta? <a href="registro.php" style="color: var(--cyan); font-weight: 600;">Regístrate aquí</a>
        </div>
      </div>
